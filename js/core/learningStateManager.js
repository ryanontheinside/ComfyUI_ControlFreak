...
export class LearningStateManager {
    ...
    startQuickLearning(node, widget, defaultSettings) {
        ...
        console.log(`ControlFreak: Quick learning started for widget: ${widget.name} on node: ${node.id}`);
    }
    ...
    completeLearning(mapping) {
        ...
        // console.log(`[ControlFreak Debug] completeLearning finished setting flags. isQuickLearning is now: ${this._isQuickLearning}`); // Log state immediately after setting
