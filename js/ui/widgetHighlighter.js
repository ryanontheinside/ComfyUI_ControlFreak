...
function applyWidgetHighlightPatch() {
    ...
    console.log("ControlFreak: Applying widget highlight patch to LGraphCanvas.drawNodeWidgets.");
...
function removeWidgetHighlightPatch() {
    if (original_drawNodeWidgets && LiteGraph && LiteGraph.LGraphCanvas && LiteGraph.LGraphCanvas.prototype) {
        console.log("ControlFreak: Removing widget highlight patch.");
...
export function initWidgetHighlighter() {
    ...
    console.log("ControlFreak: Widget highlighter initialized and listening for mapping changes.");
}
...
export function cleanupWidgetHighlighter() {
     ...
     // TODO: Remove eventBus listeners if this module supports full dynamic unloading
     console.log("ControlFreak: Widget highlighter cleaned up.");
}
